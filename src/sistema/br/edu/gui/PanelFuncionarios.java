	...
	public void popularTabela() {
		...
		try {
			...
			for (Funcionario funcionario : lista) {
				modeloTabela.addRow(new String[] { funcionario.getIdfuncionario().toString(),
						funcionario.getTelefone().toString(), funcionario.getNome().toString(),
						funcionario.getEndereco().toString(), funcionario.getFuncao().toString() });
			}
