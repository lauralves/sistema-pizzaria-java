...
public class GuiAtendente extends JFrame {
	...
	public GuiAtendente() {
		...
		lblPizzaLogo.setIcon(new ImageIcon(GuiAtendente.class.getResource("/images/pizza (2).png")));
		...
		lblIconMenu.setIcon(new ImageIcon(GuiAtendente.class.getResource("/images/casa (2).png")));
		...
		lblIconPedidos.setIcon(new ImageIcon(GuiAtendente.class.getResource("/images/bicicleta-de-entrega.png")));
		...
		lblIconSair.setIcon(new ImageIcon(GuiAtendente.class.getResource("/images/sair.png")));
