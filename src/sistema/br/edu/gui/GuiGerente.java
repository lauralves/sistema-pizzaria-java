...
public class GuiGerente extends JFrame {
	...
	public GuiGerente() {
		...
		lblPizzaLogo.setIcon(new ImageIcon(GuiGerente.class.getResource("/images/pizza (2).png")));
		...
		lblIconSabores.setIcon(new ImageIcon(GuiGerente.class.getResource("/images/cozinha (2).png")));
		...
		lblIconRelatorio.setIcon(new ImageIcon(GuiGerente.class.getResource("/images/note.png")));
		...
		lblIconFuncionarios.setIcon(new ImageIcon(GuiGerente.class.getResource("/images/companhia.png")));
		...
		lblIconEstoque.setIcon(new ImageIcon(GuiGerente.class.getResource("/images/doacao-de-alimentos.png")));
		...
		lblIconSair.setIcon(new ImageIcon(GuiGerente.class.getResource("/images/sair.png")));
