...
public class GuiLogin extends JFrame {
	...
	public GuiLogin() {
		...
		btnEntrar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					JOptionPane.showMessageDialog(null, "Erro" + e2, "Erro", JOptionPane.ERROR_MESSAGE);
				}
		...
		btnEntrar.setBounds(485, 298, 119, 36);
		...
		lblNewLabel_4.setIcon(new ImageIcon(GuiLogin.class.getResource("/images/homem-de-negocios.png")));
		lblNewLabel_4.setBounds(225, 0, 58, 36);
		pnlUsuario.add(lblNewLabel_4);

		JSeparator separator_1 = new JSeparator();
		separator_1.setBounds(395, 208, 229, 36);
		...
		lblNewLabel_5.setIcon(new ImageIcon(GuiLogin.class.getResource("/images/fechadura.png")));
		lblNewLabel_5.setBounds(245, 0, 38, 36);
		pnlSenha.add(lblNewLabel_5);

		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_2.setIcon(new ImageIcon(GuiLogin.class.getResource("/images/logo-pzzaria (1).jpg")));
